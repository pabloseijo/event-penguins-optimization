#!/usr/bin/env python3
"""Cross-fit a linear QFL quality scorer on THUMOS14 ActionFormer candidates."""
...
def build_design(
    ...
    global_ranks = classwise_percentile_ranks(
...
def main() -> None:
    ...
    for fold, validation_videos in enumerate(all_folds):
        ...
        training_designs = build_design(training_videos, num_classes)
        validation_designs = build_design(validation_videos, num_classes)
        ...
        del training_designs, features, targets, weights
