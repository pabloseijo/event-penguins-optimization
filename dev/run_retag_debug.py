...
class ProposalGenerator:
    ...
    def __init__(self, data_path, bin_width, percentile, nms_threshold) -> None:
        self.log_file = "retag_debug_dinamic_threshold.txt"

        # limpa o ficheiro ao comezo
    ...
    def process_recording(self, rec):
        ...
        with h5py.File(self.data_path, "r") as file:
            ...
            for roi_id in roi_ids:
                ...
                adaptive_thresholds = get_adaptive_actioness_thresholds(
                    actioness,
                ...
                log_to_txt(self.log_file, f"adaptive thresholds: {adaptive_thresholds.tolist()}")
    ...
    def run(self):
        ...
        for rec in recordings:
            log_to_txt(self.log_file, f"[INFO] processing recording: {rec}")
            rec_proposals = self.process_recording(rec)
...
if __name__ == "__main__":
    generator = ProposalGenerator(
        data_path="tmp/sample_preprocessed.h5",
